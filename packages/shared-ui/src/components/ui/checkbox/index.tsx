  ...
  'peer inline-flex items-center justify-center rounded border-2 border-border bg-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50',
  {
    variants: {
      variant: {
        ...
        primary:
          'border-indigo-500 data-[state=checked]:bg-indigo-500 data-[state=checked]:border-indigo-500',
        success:
        ...
        outline:
          'border-input data-[state=checked]:bg-transparent data-[state=checked]:border-primary',
        subtle:
          'border-muted data-[state=checked]:bg-accent data-[state=checked]:border-accent',
        glass:
          'border-foreground/30 data-[state=checked]:bg-foreground/10 data-[state=checked]:border-foreground/50',
...
const Checkbox = React.forwardRef<HTMLInputElement, CheckboxProps>(
  (
    ...
    const CheckboxLabel = label && (
      <motion.label
        className={cn(labelVariants({ size, disabled }), 'select-none')}
      ...
      return (
        ...
        >
          ...
          >
            ...
            <motion.svg
              className={cn(
                'relative h-full w-full z-10 pointer-events-none',
                getCheckmarkColor(),
              )}
              viewBox="0 0 24 24"
              fill="none"

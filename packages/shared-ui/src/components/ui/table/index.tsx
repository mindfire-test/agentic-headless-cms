...
export interface TableProps {
  headings: Array<
    ...
    | string
  >;
  data: Array<Record<string, React.ReactNode> | React.ReactNode[]>;
  ...
  glow?: boolean;
  rowKeyExtractor?: (
    row: Record<string, React.ReactNode> | React.ReactNode[],
    index: number,
  ) => string;
}
        ...
        <RadixTable.Header className="bg-gray-50 dark:bg-gray-800">
          <RadixTable.Row>
            {headings.map((h, i) => {
              ...
              const sort = typeof h === 'string' ? undefined : h.sort;
              ...
              return (
                <RadixTable.ColumnHeaderCell
                  ...
                  className={cn(
                    ...
                    showHoverEffects && hoveredColumn === key
              ...
              return (
                ...
                >
                  {headings.map((h, colIndex) => {
                    const key = typeof h === 'string' ? h : h.key;
                    const cellContent = Array.isArray(row)
                      ? row[colIndex]
                      : row[key];
                    return (
                      <RadixTable.Cell
                        ...
                        className={cn(
                          ...
                          showBorders
                            ...
                            : '',
                          showHoverEffects && hoveredRow === index
                            ? 'font-semibold'
                            : '',
                        )}
                      >
...
export function Table(
  ...
  return (
    <Theme radius="large" appearance="inherit" {...(rest as any)}>

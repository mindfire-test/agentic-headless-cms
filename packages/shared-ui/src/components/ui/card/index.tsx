...
const cardHeaderVariants = cva('flex flex-col space-y-1.5 relative', {
  variants: {
    variant: {
      default: 'p-6',
      compact: 'p-4',
...
type CardHeaderProps = React.PropsWithChildren<
  HTMLMotionProps<'div'> & VariantProps<typeof cardHeaderVariants>
>;
...
const cardTitleVariants = cva('font-semibold leading-none tracking-tight', {
  variants: {
    ...
    gradient: {
      ...
      green:
        'bg-gradient-to-r from-success to-green-600 bg-clip-text text-transparent',
...
type CardTitleProps = React.PropsWithChildren<
  HTMLMotionProps<'h3'> & VariantProps<typeof cardTitleVariants>
>;
...
type CardDescriptionProps = React.PropsWithChildren<
  HTMLMotionProps<'p'> & VariantProps<typeof cardHeaderVariants>
>;
...
const cardContentVariants = cva('relative', {
  variants: {
    variant: {
      default: 'p-6 pt-0',
      compact: 'p-4 pt-0',
...
const cardFooterVariants = cva('flex items-center relative', {
  variants: {
    variant: {
      default: 'p-6 pt-0',
      compact: 'p-4 pt-0',

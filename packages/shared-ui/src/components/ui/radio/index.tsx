  ...
  'relative inline-flex items-center justify-center rounded-full border-2 bg-background transition-colors duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50',
  {
    variants: {
      variant: {
        ...
        neon: 'border-pink-500 data-[state=checked]:bg-pink-500 data-[state=checked]:border-pink-500 shadow shadow-pink-500/40',
      },
      disabled: {
        true: 'cursor-not-allowed border-gray-500 data-[state=checked]:bg-gray-500 data-[state=checked]:border-gray-500 opacity-50',
        false: '',
      },
      size: {
        xs: 'h-3 w-3',
    ...
    >
      {options.map((opt) => (
        ...
        >
          ...
          <motion.div
            variants={
              radioMotionVariants[animationVariant] ||
              radioMotionVariants.bounce
            }
            initial="unchecked"

...
> = {
  primary: {
    backdrop:
      'bg-gradient-to-br from-primary/30 via-background/80 to-accent/30',
    content:
    ...
    closeButton:
      'hover:text-primary hover:bg-primary/15 active:bg-primary/25 focus:ring-primary/50',
    cancelButton:
      'hover:bg-accent/80 hover:text-accent-foreground hover:border-accent/30 focus:ring-accent/50',
    confirmButton:
  ...
  accent: {
    backdrop:
      'bg-gradient-to-br from-accent/40 via-background/80 to-primary/20',
    content:
    ...
    closeButton:
      'hover:text-accent-foreground hover:bg-accent/30 active:bg-accent/40 focus:ring-accent/50',
  ...
  success: {
    backdrop:
      'bg-gradient-to-br from-success/25 via-background/80 to-primary/20',
    content:
    ...
    closeButton:
      'hover:text-success hover:bg-success/15 active:bg-success/25 focus:ring-success/50',
  ...
  warning: {
    backdrop:
      'bg-gradient-to-br from-warning/25 via-background/80 to-primary/20',
    content:
    ...
    closeButton:
      'hover:text-warning hover:bg-warning/15 active:bg-warning/25 focus:ring-warning/50',
  ...
  destructive: {
    backdrop:
      'bg-gradient-to-br from-destructive/25 via-background/80 to-primary/20',
    content:
    ...
    closeButton:
      'hover:text-destructive hover:bg-destructive/15 active:bg-destructive/25 focus:ring-destructive/50',
  ...
  info: {
    ...
    closeButton:
      'hover:text-info hover:bg-info/15 active:bg-info/25 focus:ring-info/50',
...
type ModalComponentType = React.MemoExoticComponent<

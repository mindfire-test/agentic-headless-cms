...
const formVariants = cva('w-full', {
  variants: {
    ...
    labels: {
      ...
      floating:
        '[&_.form-field]:relative [&_.form-field_label]:absolute [&_.form-field_label]:left-3 [&_.form-field_label]:top-0 [&_.form-field_label]:-translate-y-1/2 [&_.form-field_label]:bg-background [&_.form-field_label]:px-1 [&_.form-field_label]:text-xs [&_.form-field_label]:font-medium [&_.form-field_label]:text-muted-foreground [&_.form-field_label]:transition-all [&_.form-field_input:focus~label]:text-primary [&_.form-field_input:not(:placeholder-shown)~label]:text-primary',
    },
  },
  defaultVariants: {
    spacing: 'comfortable',
...
const Form = React.forwardRef<HTMLDivElement, FormProps>(
  (
    ...
    const gridClasses = hasColumns
      ? `grid ${getGridColumns(columns)} gap-x-4`
      : '';

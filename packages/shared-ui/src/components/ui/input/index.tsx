...
const inputVariants: Record<string, InputVariant> = {
  ...
  floating: {
    ...
    input: {
      ...
      animate: {
        boxShadow:
          '0 8px 25px rgba(59, 130, 246, 0.15), 0 4px 12px rgba(0,0,0,0.1)',
  ...
  borderGlow: {
    ...
    input: {
      ...
      animate: {
        boxShadow:
          '0 0 0 3px rgba(246, 134, 59, 0.3), 0 0 20px rgba(246, 134, 59, 0.2)',
        borderColor: 'var(--primary)',
      },
    },
  },
  ...
  magnetic: {
    ...
    input: {
      ...
      animate: {
        ...
        backgroundImage:
          'linear-gradient(90deg, transparent 30%, rgba(59, 130, 246, 0.1) 50%, transparent 70%)',
        borderColor: 'var(--primary)',
        boxShadow: '0 4px 15px var(--primary)',
        transition: {
          backgroundPosition: {
  ...
  neon: {
    label: {
      ...
      animate: {
        textShadow:
          '0 0 12px #fff, 0 0 24px var(--primary), 0 0 36px var(--primary)',
        y: -32,
        color: 'var(--primary)',
      },
    },
    input: {
      ...
      animate: {
        boxShadow:
          '0 0 8px var(--primary), 0 0 16px var(--primary), 0 0 24px var(--primary), 0 0 32px var(--primary)',
        borderColor: 'var(--primary)',
        transition: {
          boxShadow: {
            repeat: Infinity,
  ...
  cosmic: {
    ...
    input: {
      ...
      animate: {
        backgroundPosition: '100% 50%',
        backgroundImage:
          'linear-gradient(45deg, rgba(139, 92, 246, 0.1), rgba(236, 72, 153, 0.1), rgba(139, 92, 246, 0.1))',
        borderColor: 'var(--primary)',
  ...
  holographic3D: {
    ...
    input: {
      ...
      animate: {
        borderColor: 'var(--primary)',
        boxShadow:
          '0 0 20px var(--primary), 0 8px 16px var(--primary), inset 0 1px 0 var(--primary)',
  ...
  quantumParticles: {
    ...
    input: {
      ...
      animate: {
        ...
        boxShadow: '0 0 20px var(--primary)',
        background:
          'linear-gradient(45deg, rgba(var(--primary), 0.05) 0%, rgba(236, 72, 153, 0.05) 50%, rgba(var(--primary), 0.05) 100%)',
      },
    },
    extra: {
      initial: {
  ...
  cosmicField: {
    ...
    input: {
      ...
      animate: {
        ...
        background:
          'radial-gradient(ellipse at center, rgba(139, 92, 246, 0.1) 0%, rgba(236, 72, 153, 0.05) 50%, transparent 100%)',
        boxShadow:

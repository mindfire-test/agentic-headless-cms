...
const AnimatedTextarea: React.FC<AnimatedTextareaProps> = ({
  ...
  const handleChange = (e: React.ChangeEvent<HTMLTextAreaElement>) => {
    ...
    if (
      (variant === 'expandable' || variant === 'smoothExpand' || autoResize) &&
      textareaRef.current
    ) {
        ...
        {(variant === 'characterCount' || showCharacterCount) && (
          <motion.div
            className={cn(
              ...
              isNearLimit &&
                !isOverLimit &&
                'text-amber-600 border-amber-400/40 bg-amber-50/80 dark:bg-amber-950/80',
              isOverLimit &&
                'text-red-600 border-red-400/40 bg-red-50/80 dark:bg-red-950/80',
...
const textareaVariants: Record<string, TextareaVariant> = {
  clean: {
    ...
    textarea: {
      ...
      animate: {
        ...
        boxShadow:
          '0 0 0 3px rgba(var(--primary), 0.1), 0 4px 12px rgba(var(--primary), 0.1)',
      },
    },
  },
  ...
  glowBorder: {
    ...
    textarea: {
      ...
      animate: {
        boxShadow:
          '0 0 0 3px rgba(var(--border), 0.3), 0 0 20px rgba(var(--border), 0.2)',
        borderColor: 'var(--primary)',
      },
    },
  },
  ...
  neonGlow: {
    label: {
      ...
      animate: {
        textShadow:
          '0 0 12px var(--primary), 0 0 24px var(--primary), 0 0 36px var(--primary)',
        y: -32,
        color: 'var(--primary)',
      },
    },
    textarea: {
      ...
      animate: {
        boxShadow:
          '0 0 8px var(--primary), 0 0 16px var(--primary), 0 0 24px var(--primary)',
        borderColor: 'var(--primary)',
        transition: {
          boxShadow: {
            repeat: Infinity,
  ...
  spotlight: {
    label: {
      ...
      animate: {
        y: -32,
        filter:
          'brightness(1.3) drop-shadow(0 0 8px rgba(var(--primary), 0.5))',
        color: 'var(--primary)',
      },
    },
    textarea: {
  ...
  hologram: {
    ...
    textarea: {
      ...
      animate: {
        ...
        borderColor: 'var(--primary)',
        boxShadow:
          '0 0 20px rgba(var(--primary), 0.4), inset 0 0 20px rgba(var(--primary), 0.1)',
        transition: {
          opacity: { repeat: Infinity, duration: 2.5, ease: 'easeInOut' },
        },
      },
